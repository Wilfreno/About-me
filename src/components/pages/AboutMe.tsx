...
export default function AboutMe() {
  return (
    <>
      ...
      <div className="hidden grow leading-[1.5rem] px-5 my-5 text-sm  flex-col items-center justify-center md:flex lg:text-xl lg:leading-[2rem] md:px-0">
        <motion.p
      ...
      <div className="grow leading-[1.5rem] px-5 my-5 text-md flex flex-col items-center justify-center md:hidden">
        <motion.p
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
